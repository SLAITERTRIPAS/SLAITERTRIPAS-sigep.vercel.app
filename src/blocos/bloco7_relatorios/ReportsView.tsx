...
export default function ReportsView({
  ...
  const renderTypeSelection = () => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-full mx-auto mt-12">
      <button
        onClick={() => {
  ...
  const renderWorkflow = () => {
    ...
    return (
      <motion.div
        ...
        className="w-full max-w-full mx-auto space-y-8"
      >
...
function ReportEditor({
  ...
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      className="max-w-full mx-auto bg-white shadow-2xl min-h-screen flex flex-col mb-12"
    >
