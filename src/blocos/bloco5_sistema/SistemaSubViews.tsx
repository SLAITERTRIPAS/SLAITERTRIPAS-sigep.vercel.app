          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                Pretende definir uma nova senha para <strong className="text-gray-950">{resetConfirmUser.name}</strong>?
              </p>

              <div className="mb-6">
                <label className="block text-xs font-black text-gray-500 tracking-widest mb-2 uppercase">
                  Nova Senha
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-black text-gray-900 focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all"
