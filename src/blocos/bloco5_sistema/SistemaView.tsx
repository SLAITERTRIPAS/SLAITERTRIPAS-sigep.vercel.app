  ...
  return (
    <div className="flex-1 w-full bg-[#f8f9fa] flex flex-col font-sans relative overflow-hidden">
      <div className="flex-grow flex overflow-hidden">
        <main
          className={`flex-grow overflow-hidden bg-[#f8f9fa] flex flex-col min-h-0 min-w-0 relative ${
        ...
        <aside className={`transition-all duration-300 ${isMenuOpen ? 'w-80 opacity-100' : 'w-0 overflow-hidden opacity-0'} bg-[#000066] text-white flex flex-col shadow-2xl z-20 shrink-0`}>
