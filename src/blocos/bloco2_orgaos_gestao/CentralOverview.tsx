...
export default function CentralOverview({
  ...
  if (activeView === "efetivo") {
    return (
      <div className="w-full max-w-full mx-auto p-4 sm:p-6 space-y-6 animate-fadeIn">
  ...
  return (
    <div className="w-full max-w-full mx-auto p-4 sm:p-8 space-y-8 animate-fadeIn">
