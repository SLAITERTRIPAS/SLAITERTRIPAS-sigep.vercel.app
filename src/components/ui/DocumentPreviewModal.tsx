    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className={`bg-white w-full ${isFullscreen ? "h-full rounded-none" : "max-w-full h-[94vh] rounded-3xl"} shadow-2xl border border-slate-200 flex flex-col overflow-hidden relative`}
        >
          {/* Header & Reader Bar */}
